                ...
                <div class="row g-4 justify-content-center text-center">
                        ...
                        <div class="service-item bg-light rounded">
                            ...
                            <div class="service-content text-center p-4">
                                <div class="service-content-inner">
                                    <a href="#" class="h4 mb-4 d-inline-flex text-start"><i class="fas fa-donate fa-2x me-2"></i> Investment Opportunities</a>
                                    <p class="mb-4">Discover vetted investment opportunities in diverse sectors across Africa. Our platform enables investors to find, evaluate, and support projects that align with their goals and values.</p>
                        ...
                        <div class="service-item bg-light rounded">
                            ...
                            <div class="service-content text-center p-4">
                                <div class="service-content-inner">
                                    ...
                                    <p class="mb-4">Our team provides expert guidance to both investors and companies, helping you navigate the investment landscape, structure deals, and achieve sustainable growth.</p>
                                    <a class="btn btn-light rounded-pill py-2 px-4" href="#">Read More</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item bg-light rounded">
                            ...
                            <div class="service-content text-center p-4">
                                <div class="service-content-inner">
                                    <a href="#" class="h4 mb-4 d-inline-flex text-start"><i class="fas fa-donate fa-2x me-2"></i> Investment Planning</a>
                                    <p class="mb-4">We offer tailored investment planning services, from portfolio diversification to risk assessment, ensuring your capital works efficiently for you and the communities you support.</p>
                                    <a class="btn btn-light rounded-pill py-2 px-4" href="#">Read More</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="service-item bg-light rounded">
                            ...
                            <div class="service-content text-center p-4">
                                <div class="service-content-inner">
                                    <a href="#" class="h4 mb-4 d-inline-flex text-start"><i class="fas fa-donate fa-2x me-2"></i> Business Support</a>
                                    <p class="mb-4">PMAD-IRMS supports entrepreneurs and companies with business development, mentorship, and access to a network of partners and resources to accelerate their success.</p>
                                    <a class="btn btn-light rounded-pill py-2 px-4" href="#">Read More</a>
                                </div>
                            </div>
                        </div>
